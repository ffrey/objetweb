<?php
// phpunit C:\wamp\lib\ow\phpcs\AllSniffsPubSf1.php
/**
...
// $dir = 'C:\wamp\bin\php\php5.3.5\tests\PHP_CodeSniffer\CodeSniffer\Standards';
// require_once $dir . DIRECTORY_SEPARATOR . 'AbstractSniffUnitTest.php';
...
define('PHP_CODESNIFFER_VERBOSITY', 3);
/**
 * A test class for testing all sniffs for installed standards.
 *
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class PHP_CodeSniffer_Standards_AllSniffs_PubSf1
{
    ...
    public static function suite()
    {
		...
		$standards = array('PubSf1');// 
		var_dump('is installed', $isInstalled); 
        ...
        foreach ($standards as $standard) {
            ...
            if (is_dir($standardDir) === false) {
                echo sprintf('No tests for this standard : %s in %s', $standard, $standardDir)."\n\r";
				exit;
                continue;
            }
